...
namespace Utility.通用
{
    ...
    class H写文件 : TraceListener
    {
            ...
            get
            {
                ...
                switch (this.Location)
                {
                    ...
                    case LogFileLocation.Custom:
                        path1 = !string.IsNullOrEmpty(this.CustomLocation) ? this.CustomLocation : Path.GetDirectoryName(Application.ExecutablePath); 
                        break;
                    default:
                        path1 = Application.UserAppDataPath;
                        break;
            ...
            : base(name)
        {
            ...
            this.BaseFileName = Path.GetFileNameWithoutExtension(Application.ExecutablePath);
